...
def generate_model(hps):
    ...
    """Generate and compile a LSTM model based on given hyperparameters."""
...
def draw_history(history):
    ...
    """Draw and save plots for training and validation loss history."""
...
def split_data(hps, X, y):
    ...
    """Split data into training and validation sets based on hyperparameter settings."""
